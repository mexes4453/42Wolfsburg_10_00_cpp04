...
int main ( void )
{
    INFO(TEST: Subject file cases - No Abstract class);
    Animal tiger = Animal("tiger");   //valid instance of class
    ...
    dynamic_cast<Cat*>(const_cast<Animal*>(c))->getBrainAddr()->storeIdea("Hello");
    dynamic_cast<Cat*>(const_cast<Animal*>(c))->getBrainAddr()->storeIdea("Kitty");
    dynamic_cast<Cat*>(const_cast<Animal*>(c))->getBrainAddr()->showAllIdeas();
    delete c;


    INFO(TEST: Check the dog brain feature);
    const Animal *d = new Dog();
    dynamic_cast<Dog*>(const_cast<Animal*>(d))->getBrainAddr()->storeIdea("Hi");
    dynamic_cast<Dog*>(const_cast<Animal*>(d))->getBrainAddr()->storeIdea("Puppy");
    dynamic_cast<Dog*>(const_cast<Animal*>(d))->getBrainAddr()->showAllIdeas();
    delete d;
